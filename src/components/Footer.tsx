...
const SERVICE_LINKS = [
  ...
  { href: "/services#growth-services", label: "Growth Services" },
...
export default function Footer() {
  return (
    <footer className="border-t border-line">
      ...
      <div className="border-t border-line px-6 pt-6 text-center text-sm italic text-ash/60 lg:px-10">
        Reconnect with every customer you almost lost.
      </div>

      <div className="px-6 pb-20 pt-4 text-center text-xs text-ash/70 lg:px-10">
